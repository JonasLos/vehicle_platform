...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "v2x_safety_bridge_publish_non_safety_facility",
                default_value="false",
                description="If true, publish all facility notifications; if false publish only safety-mapped ones",
            ),
            DeclareLaunchArgument(
                "v2x_safety_bridge_min_publish_interval",
                default_value="0.2",
                description="Minimum interval in seconds between repeated bridge alerts of same key/type",
            ),
            DeclareLaunchArgument(
                "v2x_safety_bridge_enablement_json",
                default_value='{"fcw":true,"bsw":true,"lca":true,"ima":true,"eebl":true,"clw":true,"dnp":true,"pcw":true,"lta":true,"rta":true,"rew":true,"spd":true,"tiw":true,"rlv":true,"ttg":true,"glo":true,"wwe":true,"gcw":true,"hlw":true,"rww":true,"aww":true,"vru":true,"tsp":false,"ohv":true,"svw":true,"evw":true,"eaw":true,"ova":false,"vaw":false,"vtw":false,"jpw":false,"omsa":false}',
                description="JSON object overriding safety app enablement flags published by bridge",
            ),
            DeclareLaunchArgument(
                "v2x_safety_bridge_enable_debug_topic",
                default_value="true",
                description="Enable raw debug topic with every received facility message",
            ),
            DeclareLaunchArgument(
                "v2x_safety_bridge_debug_topic",
                default_value="/v2x/safety_alerts_debug_raw",
                description="Topic name for raw SDK facility debug stream",
            ),
            DeclareLaunchArgument(
                "v2x_safety_bridge_enable_raw_inbound_fallback",
                default_value="false",
                description="Also mirror /comms/inbound_binary_msg into debug stream and optional fallback safety inference",
            ),
            DeclareLaunchArgument(
                "v2x_safety_bridge_publish_safety_from_raw_inbound",
                default_value="false",
                description="Publish inferred safety alerts from raw inbound message_type hints when possible",
            ),
            DeclareLaunchArgument(
            ...
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    "safety_bridge_publish_non_safety_facility": LaunchConfiguration("v2x_safety_bridge_publish_non_safety_facility"),
                    "safety_bridge_min_publish_interval": LaunchConfiguration("v2x_safety_bridge_min_publish_interval"),
                    "safety_bridge_enablement_json": LaunchConfiguration("v2x_safety_bridge_enablement_json"),
                    "safety_bridge_enable_debug_topic": LaunchConfiguration("v2x_safety_bridge_enable_debug_topic"),
                    "safety_bridge_debug_topic": LaunchConfiguration("v2x_safety_bridge_debug_topic"),
                    "safety_bridge_enable_raw_inbound_fallback": LaunchConfiguration("v2x_safety_bridge_enable_raw_inbound_fallback"),
                    "safety_bridge_publish_safety_from_raw_inbound": LaunchConfiguration("v2x_safety_bridge_publish_safety_from_raw_inbound"),
